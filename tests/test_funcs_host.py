...
def test_max_frame_time():
    ...
    assert instance.host_tshark_max_frame_time_in(
        lambda: [{'eth.src': TEST_MAC, 'frame.time_epoch': 999}, {'eth.src': TEST_MAC, 'frame.time_epoch': 1001}]) == [{'host_key': TEST_MAC, 'max_frame_time_in': 1001}]
...
def test_both_private_ip():
    ...
    assert instance.host_tshark_both_private_ip(
        lambda: [{'eth.src': TEST_MAC, 'ip.src': '192.168.0.1', 'ip.dst': '10.10.1.1'}]) == [{'host_key': TEST_MAC, 'tshark_both_private_ip': 1}]
    assert instance.host_tshark_both_private_ip(
        lambda: [{'eth.src': TEST_MAC, 'ip.src': '192.168.0.1', 'ip.dst': '1.1.1.1'}]) == [{'host_key': TEST_MAC, 'tshark_both_private_ip': 0}]


def test_ipv4_multicast():
    instance = Host()
    assert instance.host_tshark_ipv4_multicast(
        lambda: [{'eth.src': TEST_MAC, 'ip.src': '192.168.0.1', 'ip.dst': '224.0.0.1'}]) == [{'host_key': TEST_MAC, 'tshark_ipv4_multicast': 1}]
    assert instance.host_tshark_ipv4_multicast(
        lambda: [{'eth.src': TEST_MAC, 'ip.src': '192.168.0.1', 'ip.dst': '10.0.0.2'}]) == [{'host_key': TEST_MAC, 'tshark_ipv4_multicast': 0}]


def test_tcp_flags():
    instance = Host()
    rows = lambda: [{'eth.src': TEST_MAC, 'tcp.flags': 0x00000014}]
    assert instance.host_tshark_tcp_flags_out(rows) == [{'host_key': TEST_MAC, 'tshark_tcp_flags_ack_out': 1, 'tshark_tcp_flags_cwr_out': 0, 'tshark_tcp_flags_ece_out': 0, 'tshark_tcp_flags_fin_out': 0, 'tshark_tcp_flags_ns_out': 0, 'tshark_tcp_flags_psh_out': 0, 'tshark_tcp_flags_rst_out': 1, 'tshark_tcp_flags_syn_out': 0, 'tshark_tcp_flags_urg_out': 0}]
    assert instance.host_tshark_tcp_flags_in(rows) == [{'host_key': TEST_MAC, 'tshark_tcp_flags_ack_in': 1, 'tshark_tcp_flags_cwr_in': 0, 'tshark_tcp_flags_ece_in': 0, 'tshark_tcp_flags_fin_in': 0, 'tshark_tcp_flags_ns_in': 0, 'tshark_tcp_flags_psh_in': 0, 'tshark_tcp_flags_rst_in': 1, 'tshark_tcp_flags_syn_in': 0, 'tshark_tcp_flags_urg_in': 0}]


def test_ip_flags():
    instance = Host()
    rows = lambda: [{'eth.src': TEST_MAC, 'ip.flags': 0x00004000}]
    assert instance.host_tshark_ip_flags_out(rows) == [{'host_key': TEST_MAC, 'tshark_ip_flags_rb_out': 0, 'tshark_ip_flags_df_out': 1, 'tshark_ip_flags_mf_out': 0}]
    assert instance.host_tshark_ip_flags_in(rows) == [{'host_key': TEST_MAC, 'tshark_ip_flags_rb_in': 0, 'tshark_ip_flags_df_in': 1, 'tshark_ip_flags_mf_in': 0}]


def test_ip_dsfield_flags():
    instance = Host()
    rows = lambda: [{'eth.src': TEST_MAC, 'ip.dsfield': 0x000000c0}]
    assert instance.host_tshark_ip_dsfield_out(rows) == [{'host_key': TEST_MAC, 'tshark_ip_dsfield_ecn0_out': 0, 'tshark_ip_dsfield_ecn1_out': 0, 'tshark_ip_dsfield_dscp0_out': 0, 'tshark_ip_dsfield_dscp1_out': 0, 'tshark_ip_dsfield_dscp2_out': 0, 'tshark_ip_dsfield_dscp3_out': 0, 'tshark_ip_dsfield_dscp4_out': 1, 'tshark_ip_dsfield_dscp5_out': 1}]
    assert instance.host_tshark_ip_dsfield_in(rows) == [{'host_key': TEST_MAC, 'tshark_ip_dsfield_ecn0_in': 0, 'tshark_ip_dsfield_ecn1_in': 0, 'tshark_ip_dsfield_dscp0_in': 0, 'tshark_ip_dsfield_dscp1_in': 0, 'tshark_ip_dsfield_dscp2_in': 0, 'tshark_ip_dsfield_dscp3_in': 0, 'tshark_ip_dsfield_dscp4_in': 1, 'tshark_ip_dsfield_dscp5_in': 1}]


def test_tcp_priv_ports():
    instance = Host()
    rows = lambda: [{'eth.src': TEST_MAC, 'tcp.srcport': 1025, 'tcp.dstport': 80}]
    assert instance.host_tshark_priv_tcp_ports_in(rows) == [{'host_key': TEST_MAC, 'tshark_tcp_priv_port_161_in': 0, 'tshark_tcp_priv_port_67_in': 0, 'tshark_tcp_priv_port_68_in': 0, 'tshark_tcp_priv_port_69_in': 0, 'tshark_tcp_priv_port_631_in': 0, 'tshark_tcp_priv_port_137_in': 0, 'tshark_tcp_priv_port_138_in': 0, 'tshark_tcp_priv_port_139_in': 0, 'tshark_tcp_priv_port_110_in': 0, 'tshark_tcp_priv_port_143_in': 0, 'tshark_tcp_priv_port_80_in': 1, 'tshark_tcp_priv_port_53_in': 0, 'tshark_tcp_priv_port_22_in': 0, 'tshark_tcp_priv_port_23_in': 0, 'tshark_tcp_priv_port_88_in': 0, 'tshark_tcp_priv_port_25_in': 0, 'tshark_tcp_priv_port_443_in': 0, 'tshark_tcp_priv_port_123_in': 0, 'tshark_tcp_priv_port_other_in': 0}]
    assert instance.host_tshark_priv_tcp_ports_out(rows) == [{'host_key': TEST_MAC, 'tshark_tcp_priv_port_161_out': 0, 'tshark_tcp_priv_port_67_out': 0, 'tshark_tcp_priv_port_68_out': 0, 'tshark_tcp_priv_port_69_out': 0, 'tshark_tcp_priv_port_631_out': 0, 'tshark_tcp_priv_port_137_out': 0, 'tshark_tcp_priv_port_138_out': 0, 'tshark_tcp_priv_port_139_out': 0, 'tshark_tcp_priv_port_110_out': 0, 'tshark_tcp_priv_port_143_out': 0, 'tshark_tcp_priv_port_80_out': 1, 'tshark_tcp_priv_port_53_out': 0, 'tshark_tcp_priv_port_22_out': 0, 'tshark_tcp_priv_port_23_out': 0, 'tshark_tcp_priv_port_88_out': 0, 'tshark_tcp_priv_port_25_out': 0, 'tshark_tcp_priv_port_443_out': 0, 'tshark_tcp_priv_port_123_out': 0, 'tshark_tcp_priv_port_other_out': 0}]
...
def test_wk_ip_protos():
    ...
    assert instance.host_tshark_wk_ip_protos(
        lambda: [{'eth.src': TEST_MAC, 'tcp.something': 'whatever', 'udp.something': 'whatever', 'something.else': 'something', 'data.something': 'whatever'}]) == [{'host_key': TEST_MAC, 'tshark_wk_ip_proto_arp': 0, 'tshark_wk_ip_proto_other': 1, 'tshark_wk_ip_proto_icmpv6': 0, 'tshark_wk_ip_proto_icmp': 0, 'tshark_wk_ip_proto_tcp': 1, 'tshark_wk_ip_proto_udp': 1}]
