...
def test_max_frame_len():
    instance = Host()
    assert instance.tshark_max_frame_len([{'eth.src': '0e:02:03:04:05:06', 'frame.len': 999}]) == [
        {'host_key': '0e:02:03:04:05:06', 'max_frame_len': 999}]


def test_ipversions():
    instance = Host()
    assert instance.tshark_ipv4([{'eth.src': '0e:02:03:04:05:06', 'ip.version': 4}]) == [
        {'host_key': '0e:02:03:04:05:06', 'IPv4': 1}]
    assert instance.tshark_ipv6([{'eth.src': '0e:02:03:04:05:06', 'ip.version': 6}]) == [
        {'host_key': '0e:02:03:04:05:06', 'IPv6': 1}]


def test_protocols():
    instance = Host()
    assert instance.tshark_last_protocols_array([{'eth.src': '0e:02:03:04:05:06', 'frame.protocols': 'eth:ethertype:ip:udp:db-lsp-disc:json'}]) == [
    ...
    assert instance.tshark_last_protocols_array([{'eth.src': '0e:02:03:04:05:06'}]) == [
...
def test_non_ip():
    instance = Host()
    assert instance.tshark_non_ip([{'eth.src': '0e:02:03:04:05:06', 'eth.type': 99}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_non_ip': 1}]
    assert instance.tshark_non_ip([{'eth.src': '0e:02:03:04:05:06', 'eth.type': 0x00000800}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_non_ip': 0}]


def test_vlan_id():
    instance = Host()
    assert instance.tshark_vlan_id([{'eth.src': '0e:02:03:04:05:06', 'vlan.id': 999}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_vlan_id': 999}]


def test_ipx():
    instance = Host()
    assert instance.tshark_ipx([{'eth.src': '0e:02:03:04:05:06', 'eth.type': 0x8137}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_ipx': 1}]
    assert instance.tshark_ipx([{'eth.src': '0e:02:03:04:05:06', 'eth.type': 0x800}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_ipx': 0}]


def test_both_private_ip():
    instance = Host()
    assert instance.tshark_both_private_ip([{'eth.src': '0e:02:03:04:05:06', 'ip.src': '192.168.0.1', 'ip.dst': '10.10.1.1'}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_both_private_ip': 1}]
    assert instance.tshark_both_private_ip([{'eth.src': '0e:02:03:04:05:06', 'ip.src': '192.168.0.1', 'ip.dst': '1.1.1.1'}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_both_private_ip': 0}]


def test_ipv4_multicast():
    instance = Host()
    assert instance.tshark_ipv4_multicast([{'eth.src': '0e:02:03:04:05:06', 'ip.src': '192.168.0.1', 'ip.dst': '224.0.0.1'}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_ipv4_multicast': 1}]
    assert instance.tshark_ipv4_multicast([{'eth.src': '0e:02:03:04:05:06', 'ip.src': '192.168.0.1', 'ip.dst': '10.0.0.2'}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_ipv4_multicast': 0}]


def test_tcp_flags():
    instance = Host()
    assert instance.tshark_tcp_flags_out([{'eth.src': '0e:02:03:04:05:06', 'tcp.flags': 0x00000014}]) == [
    ...
    assert instance.tshark_tcp_flags_in([{'eth.src': '0e:02:03:04:05:06','tcp.flags': 0x00000014}]) == [
...
def test_ip_flags():
    instance = Host()
    assert instance.tshark_ip_flags_out([{'eth.src': '0e:02:03:04:05:06', 'ip.flags': 0x00004000}]) == [
        {'host_key': '0e:02:03:04:05:06', 'tshark_ip_flags_rb_out': 0, 'tshark_ip_flags_df_out': 1, 'tshark_ip_flags_mf_out': 0}]
    assert instance.tshark_ip_flags_in([{'eth.src': '0e:02:03:04:05:06', 'ip.flags': 0x00004000}]) == [
...
def test_ip_dsfield_flags():
    instance = Host()
    assert instance.tshark_ip_dsfield_out([{'eth.src': '0e:02:03:04:05:06', 'ip.dsfield': 0x000000c0}]) == [
    ...
    assert instance.tshark_ip_dsfield_in([{'eth.src': '0e:02:03:04:05:06', 'ip.dsfield': 0x000000c0}]) == [
...
def test_tcp_priv_ports():
    instance = Host()
    assert instance.tshark_priv_tcp_ports_in([{'eth.src': '0e:02:03:04:05:06', 'tcp.srcport': 1025, 'tcp.dstport': 80}]) == [
    ...
    assert instance.tshark_priv_tcp_ports_out([{'eth.src': '0e:02:03:04:05:06', 'tcp.srcport': 1025, 'tcp.dstport': 80}]) == [
...
def test_udp_priv_ports():
    instance = Host()
    assert instance.tshark_priv_udp_ports_in([{'eth.src': '0e:02:03:04:05:06', 'udp.srcport': 1025, 'udp.dstport': 123}]) == [
    ...
    assert instance.tshark_priv_udp_ports_out([{'eth.src': '0e:02:03:04:05:06', 'udp.srcport': 1025, 'udp.dstport': 123}]) == [
...
def test_tcp_nonpriv_ports():
    instance = Host()
    assert instance.tshark_nonpriv_tcp_ports_in([{'eth.src': '0e:02:03:04:05:06', 'tcp.srcport': 1025, 'tcp.dstport': 9999}]) == [
    ...
    assert instance.tshark_nonpriv_tcp_ports_out([{'eth.src': '0e:02:03:04:05:06', 'tcp.srcport': 1025, 'tcp.dstport': 9999}]) == [
...
def test_wk_ip_protos():
    instance = Host()
    assert instance.tshark_wk_ip_protos([{'eth.src': '0e:02:03:04:05:06', 'tcp.something': 'whatever', 'udp.something': 'whatever', 'something.else': 'something', 'data.something': 'whatever'}]) == [
